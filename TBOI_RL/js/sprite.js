$(function() {
  ...
  Sprite.load = function(url, x, y, w, h, loadedCallback) {
    var img = new Image();
    var proxy = LoaderProxy();
    
    img.onload = function() {
      var tile = Sprite(this, x, y, w, h);
  ...
  window.Sprite = function(name, x, y, w, h, callback) {
    return Sprite.load(spriteImagePath + name + ".png", x, y, w, h, callback);
  };
